...
class Trainer():
    def __init__(self, args):
        ...
        trainset = get_dataset(args.dataset, split=args.train_split, mode='train', child=args.child, **data_kwargs)
        testset = get_dataset(args.dataset, split='val', mode ='val', child=args.child, **data_kwargs)
        # dataloader
