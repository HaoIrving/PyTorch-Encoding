...
python train_sar.py --dataset sar_voc --child log_normal_new_noise_4channel --model psp  --backbone resnest269 \
--batch-size 30 --epochs 30 --warmup-epochs 2  --aux  #--ohem  --ohem-prob # --se-loss
