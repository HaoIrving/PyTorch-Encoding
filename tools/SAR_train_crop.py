        ...
        for index in range(len(name_list)):
            ...
            while x < (data.shape[1] - fil.shape[0] + 1):
                while y < (data.shape[2] - fil.shape[1] + 1):
                    ...
                    if ((1 in tem_label and 2 in tem_label and 5 in tem_label and 6 in tem_label) or (
        ...
        for i in range(len(x_y_train)):#
            ...
            for ii in range(len(x_y_train[i])):
                for iii in range(len(tem_path)):
                    ...
                    labs.append(self.cut(labels[int(train_split[i])], fil.shape[0], fil.shape[1],x_y_train[i][ii][0], x_y_train[i][ii][1]))
